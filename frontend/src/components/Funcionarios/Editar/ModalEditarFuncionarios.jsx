...
import FormEditarFuncionarios from './FormEditarFuncionarios';
...
const ModalEditarFuncionarios = ({ isOpen, onToggle}) => {
          ...
          <div className="mx-4">
            <div className="w-full min-w-[320px] lg:w-[955px] mx-auto px-2 mt-11">
              <div className="flex justify-between mb-2">
                <h1 className="text-base lg:text-lg font-semibold">Editar Funcionario</h1>
...
export default ModalEditarFuncionarios;