    ...
    return (
        ...
        >
            {isLogging ? (
                ...
                {title === 'Novo cliente' || title === 'Novo produto' || title === 'Criar NF' || title === 'Criar pedido' || title === 'Novo fornecedor' || title === 'Novo funcionario' || title === 'Criar Pagamento' || title === 'Criar Recebimento' ? (
                    <span>
